<div class="flexslider">
    <ul class="slides">
        <li>
            ...
            <img src="{{asset('assets')}}/images/templatemo_slide_1.jpg" alt="Special 1">
            <div class="container">
                <div class="row">
        ...
        <li>
            <div class="overlay"></div>
            <img src="{{asset('assets')}}/images/templatemo_slide_2.jpg" alt="Special 2">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4">
                        <div class="flex-caption visible-lg">
        ...
        <li>
            <div class="overlay"></div>
            <img src="{{asset('assets')}}/images/templatemo_slide_3.jpg" alt="Special 3">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4">
                        <div class="flex-caption visible-lg">
